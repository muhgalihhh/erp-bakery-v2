...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Point of Sale'); ?> - <?php echo e(config('app.name', 'Bakery ERP')); ?></title>
...
<body class="bg-gray-50 overflow-hidden">
    ...
    <script>
        ...
        document.addEventListener('keydown', function(e) {
            ...
            if (e.key === 'F9') {
                e.preventDefault();
                <?php if(isset($livewire)): ?>
                    window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('showPaymentModal', true);
                <?php endif; ?>
            }
...
<?php /**PATH C:\Materi Kuliah\Ifan\BakerySys v2\bakery-erp\resources\views/layouts/pos.blade.php ENDPATH**/ ?>