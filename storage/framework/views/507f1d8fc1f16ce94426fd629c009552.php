<div class="<?php echo e($isFullscreen ? 'h-full' : 'min-h-screen'); ?> bg-gradient-to-br from-blue-50 via-indigo-50 to-blue-50">
    
    <div class="flex <?php echo e($isFullscreen ? 'h-full' : 'h-screen'); ?> overflow-hidden">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <button wire:click="addToCart(<?php echo e($product->id); ?>)"
                            class="group bg-white border-2 rounded-xl p-3 hover:shadow-lg transition-all duration-200 text-left transform hover:-translate-y-0.5
                                <?php echo e($product->current_stock <= 0 ? 'opacity-50 cursor-not-allowed border-stone-200' : ''); ?>

                                <?php echo e($hasDiscount && $product->current_stock > 0 ? 'border-orange-300 hover:border-orange-500 ring-2 ring-orange-100' : 'border-amber-200 hover:border-amber-500'); ?>"
                            ...
                            <div
                                class="aspect-square rounded-lg mb-2 flex items-center justify-center transition-all relative
                                    <?php echo e($hasDiscount ? 'bg-gradient-to-br from-orange-50 to-amber-50 group-hover:from-orange-100 group-hover:to-amber-100' : 'bg-gradient-to-br from-amber-50 to-orange-50 group-hover:from-amber-100 group-hover:to-orange-100'); ?>">
                                ...
                                <?php else: ?>
                                    <svg class="w-10 h-10 <?php echo e($hasDiscount ? 'text-orange-400 group-hover:text-orange-600' : 'text-amber-400 group-hover:text-amber-600'); ?> transition-colors"
                                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasDiscount): ?>
                                    <span
                                        ...
                                        <?php echo e($productDiscountInfo['value'] ?? 'PROMO'); ?>
                            ...
                            <h3
                                class="font-semibold text-stone-900 mb-1 line-clamp-2 transition-colors text-xs leading-tight
                                    <?php echo e($hasDiscount ? 'group-hover:text-orange-600' : 'group-hover:text-amber-700'); ?>">
                                <?php echo e($product->name); ?>

                            </h3>
                            <p class="text-sm font-bold <?php echo e($hasDiscount ? 'text-orange-600' : 'text-amber-700'); ?>">
                                Rp <?php echo e(number_format($product->selling_price ?? 0, 0, ',', '.')); ?>

                            </p>
                            <p class="text-xs text-stone-500">SKU: <?php echo e($product->sku); ?></p>
        ...
        <?php echo $__env->make('livewire.pos.partials.cart-panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button wire:click="selectCustomer(<?php echo e($customer->id); ?>)"
                            class="w-full p-3 text-left rounded-lg transition-all border
                                <?php echo e($customer->is_birthday ? 'bg-gradient-to-r from-pink-50 to-rose-50 border-pink-300 hover:border-pink-400 ring-1 ring-pink-200' : 'bg-white border-amber-200 hover:bg-amber-50 hover:border-amber-400'); ?>">
                            <div class="flex justify-between items-start">
                                <div class="flex-1">
                                    <div class="flex items-center gap-2">
                                        <p class="font-medium text-stone-900"><?php echo e($customer->name); ?></p>
                                    ...
                                    <p class="text-xs text-stone-500"><?php echo e($customer->phone ?? '-'); ?> •
            ...
            <div class="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden">
                ...
                <div class="p-6 overflow-y-auto max-h-[60vh]">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedCustomer): ?>
                        <div
                            class="mb-4 p-3 rounded-xl <?php echo e($isCustomerBirthday ? 'bg-gradient-to-r from-pink-50 to-rose-50 border border-pink-200' : 'bg-amber-50 border border-amber-200'); ?>">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-2">
                                    ...
                                    <div>
                                        <p class="font-semibold text-stone-900"><?php echo e($selectedCustomer['name']); ?>
                                ...
                                <p class="text-sm text-amber-700 font-medium">
                                    <?php echo e(number_format($selectedCustomer['total_points'], 0)); ?> poin</p>
                            </div>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="mb-4 p-4 bg-amber-50 rounded-xl border border-amber-200">
                        ...
                        <div class="space-y-2 text-sm">
                            ...
                            <div class="flex justify-between text-stone-600">
                                <span><?php echo e($this->totalItems); ?> item (<?php echo e($this->totalQuantity); ?> qty)</span>
                                <span>Rp <?php echo e(number_format($subtotal, 0, ',', '.')); ?></span>
                            </div>

                            
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($discountAmount > 0 || $pointsValue > 0): ?>
                                <div class="bg-green-50 rounded-lg p-3 mt-2 border border-green-200">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($discountAmount > 0): ?>
                                        <div class="flex justify-between items-center text-green-700 mb-1">
                                            <span class="flex items-center gap-1.5">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(str_contains(strtolower($discountName ?? ''), 'birthday') || str_contains(strtolower($discountName ?? ''), 'ultah')): ?>
                                                    <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20">
                                                        <path
                                                            d="M10.75 2.75a.75.75 0 00-1.5 0v5.5a.75.75 0 001.5 0v-5.5z" />
                                                    </svg>
                                                <?php elseif(str_contains(strtolower($discountName ?? ''), 'tier') || str_contains(strtolower($discountName ?? ''), 'member')): ?>
                                                    <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20">
                                                        <path fill-rule="evenodd"
                                                ...
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                <?php echo e($discountName ?? 'Diskon'); ?>

                                            </span>
                                            <span class="font-semibold">- Rp
                                                <?php echo e(number_format($discountAmount, 0, ',', '.')); ?></span>
                                        </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pointsValue > 0): ?>
                                        <div class="flex justify-between items-center text-amber-700 mb-1">
                                            <span class="flex items-center gap-1.5">
                                                ...
                                                Poin Digunakan (<?php echo e(number_format($pointsToUse, 0)); ?> poin)
                                            </span> </span>
                                            <span class="font-semibold">- Rp
                                                <?php echo e(number_format($pointsValue, 0, ',', '.')); ?></span>
                                        </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <div
                                        ...
                                        <span>Rp
                                            <?php echo e(number_format($discountAmount + $pointsValue, 0, ',', '.')); ?></span>
                                    </div>
                                </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div class="flex justify-between text-stone-600 pt-2">
                                <span>PPN (<?php echo e($taxPercentage); ?>%)</span>
                    ...
                    <div
                        ...
                        <p class="text-4xl font-bold text-white">Rp <?php echo e(number_format($total, 0, ',', '.')); ?></p>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($discountAmount > 0 || $pointsValue > 0): ?>
                            <p class="text-green-300 text-sm mt-1 flex items-center justify-center gap-1">
                                <span class="line-through text-white/60">Rp
                                    <?php echo e(number_format($subtotal + $taxAmount, 0, ',', '.')); ?></span>
                                <span class="bg-green-500 text-white px-2 py-0.5 rounded-full text-xs font-bold">
                                    HEMAT
                                    <?php echo e(round((($discountAmount + $pointsValue) / ($subtotal > 0 ? $subtotal : 1)) * 100)); ?>%
                                </span>
                            </p>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedCustomer && $pointsEarned > 0): ?>
                        <div class="mb-4 p-3 bg-amber-50 rounded-xl border border-amber-200 text-center">
                            ...
                            <p class="text-xl font-bold text-amber-600">+<?php echo e($pointsEarned); ?> Poin</p>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="grid grid-cols-3 gap-2">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $paymentMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <button wire:click="setPaymentMethod('<?php echo e($method['code']); ?>')"
                                    class="p-3 border-2 rounded-xl transition-all <?php echo e($paymentMethod === $method['code'] ? 'border-amber-500 bg-amber-50 text-amber-700' : 'border-stone-200 hover:border-stone-300'); ?>">
            ...
            <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full max-h-[90vh] overflow-hidden" id="receipt">
                <div class="p-6">
                    ...
                    <div class="text-center mb-6">
                        ...
                        <p class="text-sm text-stone-500"><?php echo e($receipt['date'] ?? now()->format('d/m/Y H:i')); ?>
                    ...
                    <div class="bg-amber-50 rounded-xl p-3 mb-4 text-center border border-amber-200">
                        ...
                        <p class="text-xl font-bold text-amber-700"><?php echo e($receipt['order_number'] ?? '-'); ?></p>
                    </div>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $receipt['items'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex justify-between text-sm py-1">
                                <div>
                                    ...
                                    <span class="text-stone-500 text-xs">x<?php echo e($item['quantity']); ?></span>
                                </div>
                    ...
                    <div class="space-y-1 text-sm mb-4">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($receipt['discount_amount'] ?? 0) > 0 || ($receipt['points_used'] ?? 0) > 0): ?>
                            <div class="bg-green-50 rounded-lg p-2 my-2 border border-green-200">
                                ...
                                <?php if(($receipt['discount_amount'] ?? 0) > 0): ?>
                                    <div class="flex justify-between text-green-600">
                                        <span class="flex items-center gap-1">
                                            ...
                                            <?php echo e($receipt['discount_source'] ?? 'Diskon'); ?>

                                        </span>
                                        <span class="font-semibold">- Rp
                                            <?php echo e(number_format($receipt['discount_amount'], 0, ',', '.')); ?></span>
                                    </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($receipt['points_used'] ?? 0) > 0): ?>
                                    <div class="flex justify-between text-amber-600">
                                        ...
                                        <span class="font-semibold">- Rp
                                            <?php echo e(number_format($receipt['points_used'], 0, ',', '.')); ?></span>
                                    </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <div class="flex justify-end mt-1 pt-1 border-t border-green-300">
                                    <span class="text-xs text-green-700 font-bold">
                                        Total Hemat: Rp
                                        <?php echo e(number_format(($receipt['discount_amount'] ?? 0) + ($receipt['points_used'] ?? 0), 0, ',', '.')); ?>
    ...
    <?php echo $__env->make('livewire.pos.partials.clear-cart-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>
