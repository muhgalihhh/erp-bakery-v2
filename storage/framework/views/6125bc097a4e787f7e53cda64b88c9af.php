<?php $__env->startSection('title', 'POS Fullscreen'); ?>
            ...
            <div class="flex justify-between items-center">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-white/70 text-sm"><?php echo e(config('app.name', 'Bakery ERP')); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="hidden lg:flex items-center gap-6">
                    <div class="text-center px-4 py-2 bg-white/10 rounded-lg backdrop-blur-sm">
                        ...
                        <p class="text-sm font-semibold"><?php echo e(now()->translatedFormat('d F Y')); ?></p>
                    </div>
                    <div class="text-center px-4 py-2 bg-white/10 rounded-lg backdrop-blur-sm">
                        <p class="text-xs text-white/70">Waktu</p>
                        <p class="text-sm font-semibold" id="current-time"><?php echo e(now()->format('H:i:s')); ?></p>
                    </div>
                </div>
...
[$__name, $__params] = $__split('pos.point-of-sale', ['fullscreen' => true]);

$key = null;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-4264543527-0', null);
...
<?php echo $__env->make('layouts.pos', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Materi Kuliah\Ifan\BakerySys v2\bakery-erp\resources\views/pos/fullscreen.blade.php ENDPATH**/ ?>