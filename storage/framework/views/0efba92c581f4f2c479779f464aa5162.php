...
<head>
    ...
    <title><?php echo e($settings->meta_title ?? $settings->shop_name); ?></title>
    <meta name="description" content="<?php echo e($settings->meta_description ?? $settings->description); ?>">
    <meta name="keywords" content="<?php echo e($settings->meta_keywords ?? ''); ?>">

    <!-- Favicon -->
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings->logo): ?>
        <link rel="icon" type="image/x-icon" href="<?php echo e($settings->logo_url); ?>">
            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center">
                    <a href="/" class="flex items-center space-x-3">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings->logo): ?>
                            <img src="<?php echo e($settings->logo_url); ?>" alt="<?php echo e($settings->shop_name); ?>" class="h-10 w-auto">
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <span class="text-xl font-bold text-gray-900"><?php echo e($settings->shop_name); ?></span>
                    </a>
                </div>
    ...
    <footer class="bg-gray-900 text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div class="col-span-1 md:col-span-2">
                    <div class="flex items-center space-x-3 mb-4">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings->logo_dark ?? $settings->logo): ?>
                            <img src="<?php echo e($settings->logo_dark_url ?? $settings->logo_url); ?>"
                                alt="<?php echo e($settings->shop_name); ?>" class="h-10 w-auto">
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <span class="text-xl font-bold"><?php echo e($settings->shop_name); ?></span>
                    </div>
                    <p class="text-gray-400 mb-4"><?php echo e($settings->description); ?></p>

                    <!-- Social Media -->
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings->facebook_url || $settings->instagram_url || $settings->twitter_url || $settings->youtube_url): ?>
                        <div class="flex space-x-4">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings->twitter_url): ?>
                                <a href="<?php echo e($settings->twitter_url); ?>" target="_blank"
                                    class="text-gray-400 hover:text-white transition-colors">
                                    <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                                        <path
                    ...
                    <ul class="space-y-2 text-gray-400">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings->address): ?>
                            <li class="flex items-start space-x-2">
                                ...
                                <span><?php echo e($settings->address); ?>, <?php echo e($settings->city); ?></span>
                            </li>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
                <p>&copy; <?php echo e(date('Y')); ?> <?php echo e($settings->shop_name); ?>. All rights reserved.</p>
            </div>
        </div>
    </footer>
...
<?php /**PATH C:\Materi Kuliah\Ifan\BakerySys v2\bakery-erp\resources\views/layouts/landing.blade.php ENDPATH**/ ?>