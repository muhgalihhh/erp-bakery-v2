...
<div
    class="relative <?php echo e($showCartPanel ? 'w-96 xl:w-[30rem]' : 'w-16'); ?> flex flex-col bg-white shadow-2xl transition-all duration-300">
    ...
    <button wire:click="toggleCartPanel"
        ...
        title="<?php echo e($showCartPanel ? 'Sembunyikan Keranjang' : 'Tampilkan Keranjang'); ?>">
        <svg class="w-5 h-5 transition-transform <?php echo e($showCartPanel ? 'rotate-180' : ''); ?>" fill="none"
            stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
        </svg>
    </button>

    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showCartPanel): ?>
        ...
        <div class="p-5 border-b-2 border-blue-200 bg-gradient-to-r from-blue-50 to-indigo-50">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedCustomer): ?>
                <div
                    class="bg-white rounded-xl p-4 border-2 <?php echo e($isCustomerBirthday ? 'border-pink-400 ring-2 ring-pink-200' : 'border-blue-300'); ?> shadow-sm">
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            ...
                            <p class="text-xs text-gray-500 mb-2"><?php echo e($selectedCustomer['phone'] ?? '-'); ?></p>
                            <div class="flex flex-wrap items-center gap-2">
                                <span
                                    class="px-2 py-1 text-xs rounded-full bg-<?php echo e($selectedCustomer['tier_color']); ?>-100 text-<?php echo e($selectedCustomer['tier_color']); ?>-700 font-medium">
                                ...
                                <div class="mt-2 flex flex-wrap gap-1">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $customerDiscounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $discount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <span
                                            ...
                                            <?php elseif($discount['type'] === 'tier'): ?> bg-blue-100 text-blue-700 border border-blue-200
                ...
                <div class="bg-white rounded-xl p-4 border border-gray-200 shadow-sm hover:shadow-md transition-all">
                    <div class="flex justify-between items-start mb-3">
                        <div class="flex-1 pr-2">
                            <h4 class="font-semibold text-gray-900 text-sm leading-tight mb-1"><?php echo e($item['name']); ?></h4>
                            <p class="text-xs text-gray-500">SKU: <?php echo e($item['sku'] ?? '-'); ?></p>
                        </div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item['current_stock'] <= 5): ?>
                        <div class="mt-2 flex items-center gap-1 text-xs text-orange-600">
                            ...
                            Stok tersisa: <?php echo e(number_format($item['current_stock'], 0)); ?>
        ...
        <?php echo $__env->make('livewire.pos.partials.cart-summary', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php else: ?>
...
<?php /**PATH C:\Materi Kuliah\Ifan\BakerySys v2\bakery-erp\resources\views/livewire/pos/partials/cart-panel.blade.php ENDPATH**/ ?>