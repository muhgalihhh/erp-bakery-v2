...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedCustomer && $customerPoints > 0): ?>
    <div class="px-5 py-4 border-t-2 border-blue-200 bg-gradient-to-r from-blue-50 to-indigo-50">
        <div class="flex items-center justify-between mb-3">
            ...
            <span class="text-sm font-bold text-blue-600"><?php echo e(number_format($customerPoints, 0)); ?> poin</span>
        </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.pos.button','data' => ['variant' => 'primary','size' => 'sm','wire:click' => 'useAllPoints']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'primary','size' => 'sm','wire:click' => 'useAllPoints']); ?>
                Pakai Semua
...
<?php endif; ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pointsValue > 0): ?>
            <p class="text-xs text-blue-700 mt-2 flex items-center gap-1">
                ...
                Potongan: Rp <?php echo e(number_format($pointsValue, 0, ',', '.')); ?>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($cart) && ($discountAmount > 0 || !empty($customerDiscounts))): ?>
    <div class="border-t-2 border-green-300 px-5 py-4 bg-gradient-to-r from-green-50 to-emerald-50">
        ...
        <div class="flex flex-wrap gap-2">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($discountAmount > 0 && $discountName): ?>
                <span
                    ...
                    <?php echo e($discountName); ?>

                    <span class="font-bold">- Rp <?php echo e(number_format($discountAmount, 0, ',', '.')); ?></span>
                </span>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pointsValue > 0): ?>
                <span
                    ...
                    Poin <?php echo e(number_format($pointsToUse, 0)); ?>

                    <span class="font-bold">- Rp <?php echo e(number_format($pointsValue, 0, ',', '.')); ?></span>
                </span>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    </div>
...
<div class="border-t-4 border-blue-500 px-5 py-5 space-y-4 bg-gradient-to-br from-blue-50 to-indigo-50">
    <div class="space-y-3 text-sm">
        <div class="flex justify-between items-center">
            ...
            <span class="font-semibold text-gray-900">Rp <?php echo e(number_format($subtotal, 0, ',', '.')); ?></span>
        </div>

        
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($discountAmount > 0 || $tierDiscount > 0 || $pointsValue > 0): ?>
            <div class="bg-green-50 rounded-xl p-3 space-y-2 border border-green-200">
                ...
                <div
                    ...
                    <span>Rp <?php echo e(number_format($discountAmount + $pointsValue, 0, ',', '.')); ?></span>
                </div>
            </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="flex justify-between items-center">
            ...
            <span class="font-semibold text-gray-900">Rp <?php echo e(number_format($taxAmount, 0, ',', '.')); ?></span>
        </div>
    </div>
    ...
    <div class="border-t-2 border-blue-300 pt-4">
        <div class="flex justify-between items-center mb-2">
            ...
            <span class="text-2xl font-bold text-blue-700">Rp <?php echo e(number_format($total, 0, ',', '.')); ?></span>
        </div>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($discountAmount > 0 || $pointsValue > 0): ?>
            <div class="flex justify-end">
                <span
                    ...
                    Hemat Rp <?php echo e(number_format($discountAmount + $pointsValue, 0, ',', '.')); ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedCustomer && $pointsEarned > 0): ?>
        <div class="text-center py-3 bg-gradient-to-r from-yellow-100 to-amber-100 rounded-lg border border-yellow-300">
            <p class="text-sm text-yellow-800 flex items-center justify-center gap-2">
                ...
                Customer akan dapat <strong><?php echo e($pointsEarned); ?> poin</strong>
            </p>
        </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div class="flex gap-2">
        <?php if(!empty($cart)): ?>
            <?php if (isset($component)) { $__componentOriginal12393518255b06fa15daa7b187a00e6c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal12393518255b06fa15daa7b187a00e6c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.pos.button','data' => ['variant' => 'danger','size' => 'md','wire:click' => 'confirmClearCart','class' => 'flex-shrink-0']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('pos.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'danger','size' => 'md','wire:click' => 'confirmClearCart','class' => 'flex-shrink-0']); ?>
...
<?php endif; ?>
        ...
        <?php if (isset($component)) { $__componentOriginal12393518255b06fa15daa7b187a00e6c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal12393518255b06fa15daa7b187a00e6c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.pos.button','data' => ['variant' => 'success','size' => 'lg','wire:click' => 'openPaymentModal','disabled' => !$this->canCheckout,'class' => 'flex-1 text-base py-4 shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('pos.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'success','size' => 'lg','wire:click' => 'openPaymentModal','disabled' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(!$this->canCheckout),'class' => 'flex-1 text-base py-4 shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all']); ?>
...
<?php /**PATH C:\Materi Kuliah\Ifan\BakerySys v2\bakery-erp\resources\views/livewire/pos/partials/cart-summary.blade.php ENDPATH**/ ?>